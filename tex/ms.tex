...
cosine kernel (QPC) can better capture the variability due to star spots.
...
%
While these results broadly agree with the expectation that stellar
...
Nevertheless, the core idea in \citet{Morris2020}
