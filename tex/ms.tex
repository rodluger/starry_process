...
%
\xxx{FIX THE NOTATION IN THIS SECTION}
%
\begin{align}
    \label{eq:einc}
...
\end{align}
%
The expectations inside the integrals are given by
...
In this section we will compute the first and second moments of the
inclination distribution (Equations~\ref{eq:einc} and \ref{eq:Einc}),
which allows us to compute the mean and covariance of the process
...
with itself, leading to expressions like those in
...
matrix dot product. However, in practice we find it helpful to
