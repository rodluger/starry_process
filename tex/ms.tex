...
%
\begin{align}
    \pmb{\Sigma}_\mathbf{t,y} = \pmb{\Sigma}_\mathbf{t} \otimes \pmb{\Sigma}_\mathbf{y}
    \quad,
\end{align}
%
where $\pmb{\Sigma}_\mathbf{t}$ is a $(K \times K)$ matrix describing the
...
The quantity $\pmb{\Sigma}_\mathbf{t,y}$
...
$y_{n}(t_k)$ and the spherical harmonic coefficient $y_{n'}(t_{k'})$.
