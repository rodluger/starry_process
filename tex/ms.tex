...
\xxx{TODO: Brief paper outline here.}

\xxx{TODO: Discuss our open-source figures and equation ``unit tests.''}
...
\begin{figure}[t!]
    \begin{centering}
        ...
        \oscaption{calibration_default}{%
            ...
            The axes span the entire prior volume, and the blue lines and markers
...
\begin{figure}[p!]
    \begin{centering}
        \includegraphics[width=0.85\linewidth]{figures/calibration_batch_default_corner.pdf}
...
\begin{figure}[p!]
    \begin{centering}
        ...
        \xxx{TODO: Batch run with $M=1{,}000$.}
...
but for 100 trials each with $M=1{,}000$ light curves. \xxx{TODO.}
...
good agreement with the truth. \xxx{TODO: Is the radius biased high? Discuss the
    result of the batch run on 1000 limb-darkened light curves.}

\xxx{TODO: Figure~\ref{fig:calibration_unnorm}, Figure~\ref{fig:calibration_hicontrast},
    Figure~\ref{fig:calibration_bigspots}, Figure~\ref{fig:calibration_variance}.}
...
\xxx{TODO: A gentler introduction before diving in.}
...
\xxx{TODO: Discuss Figure~\ref{fig:nullspace_ensemble_ld} and how limb darkening
    changes things.}
...
\xxx{TODO: Discuss what we should do about tiny spots.}
...
\xxx{TODO: Discuss the baseline degeneracy and how to break it. Discuss the
    degeneracy between $c$ and $N$ and how to break it.}
...
\xxx{
    \begin{enumerate}
        \item The latitude distribution is not Gaussian.
        \item The number of spots does not have to be an integer.
        ...
        \item No differential rotation / spot evolution yet!
    \end{enumerate}
}

\subsection{Other distributions}
\label{sec:other-dist}
\xxx{TODO: Discuss the uniform spot radius distribution.}

\subsection{Prior on sigma}
\label{sec:sigma-prior}
\xxx{TODO: We might want a shrinkage prior on sigma.}

\subsection{Inferring inclinations}
\xxx{TODO: Works great. But inclination distribution is bimodal!}


\section{Implementation}
\label{sec:implementation}

\xxx{TODO: Discuss the Python code here.}

\section{Conclusions}
\xxx{TODO: Summarize. Discuss future work, including differential rotation
and spot evolution.}
...
\begin{figure}[p!]
    \begin{centering}
        \oscaption{calibration_hicontrast}{%
            \xxx{TODO: Two high contrast spots.}
...
\begin{figure}[p!]
    \begin{centering}
        \oscaption{calibration_variance}{%
            \xxx{TODO: Variance in all input parameters.}
