...
above. \xxx{NOTE: I'm actually no long sure this would work! DFM, let's chat about this.}
...
\label{sec:mixture}
\xxx{TODO: kernels can be summed!}
...
\begin{proof}{test_temporal}
    ...
    \left(\pmb{\Sigma}_\mathbf{t} \otimes \pmb{\Sigma}_\mathbf{y}\right)
    {\pmb{\mathcal{A}}^\ddagger}^\top
    &=
    \pmb{\Sigma} \odot \pmb{\Sigma}_\mathbf{t}
\end{proof}
%
where
%
