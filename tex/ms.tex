...
\begin{abstract}
    ...
    variability due to star spots rotating in and out of view is treated
...
or its surface. While the GP period $P$
...
and the timescale $\tau$ and physical properties of the spots is much fuzzier.
...
a free parameter \xxx{(CITE ME)}. In addition to this being a numerically challenging
...
zero effect on the light curve \citep[e.g.,][]{Cowan2013,Luger2019}.
