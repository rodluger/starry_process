...
%
\begin{align}
    \mathbf{f}\left(I, P, \mathbf{u}, \pmb{\theta}_\bullet\right) \sim
    \mathcal{N}\Big(
...
\begin{align}
    ...
    \pmb{\mu}(I, P, \mathbf{u}, \pmb{\theta}_\bullet)
     & = \mathrm{E} \Big[ \mathbf{f} \, \Big| \, I, P, \mathbf{u}, \pmb{\theta}_\bullet \Big]
    \\
    \label{eq:cov}
    \pmb{\Sigma}(I, P, \mathbf{u}, \pmb{\theta}_\bullet)
     & = \mathrm{E} \Big[ \mathbf{f} \, \mathbf{f}^\top \, \Big| \, I, P, \mathbf{u}, \pmb{\theta}_\bullet \Big] - \pmb{\mu}(I, P, \mathbf{u}, \pmb{\theta}_\bullet) \pmb{\mu}^\top(I, P, \mathbf{u}, \pmb{\theta}_\bullet)
    \quad.
\end{align}
%
...
\begin{align}
    \label{eq:mu_marg}
    \pmb{\mu}(P, \mathbf{u}, \pmb{\theta}_\bullet)
     & = \mathrm{E} \Big[ \mathbf{f} \, \Big| \, P, \mathbf{u}, \pmb{\theta}_\bullet \Big]
    \nonumber                                                                                                                                                                                                      \\
     & = \mathbf{1} + \mathbf{e}_I
    \\[0.5em]
    \label{eq:cov_marg}
    \pmb{\Sigma}(P, \mathbf{u}, \pmb{\theta}_\bullet)
     & = \mathrm{E} \Big[ \mathbf{f} \, \mathbf{f}^\top \, \Big| \, P, \mathbf{u}, \pmb{\theta}_\bullet \Big] - \pmb{\mu}(P, \mathbf{u}, \pmb{\theta}_\bullet) \pmb{\mu}^\top(P, \mathbf{u}, \pmb{\theta}_\bullet)
    \nonumber                                                                                                                                                                                                      \\
     & =
    \mathbf{E}_I
    -
...
\begin{align}
    ...
    \mathbf{e}_I
     & \equiv
    \mathrm{E} \Big[ \pmb{\mathcal{A}} \, \mathbf{y} \, \Big| \, P, \mathbf{u}, \pmb{\theta}_\bullet \Big]
    \nonumber \\[0.5em]
     & =
    \int
    \pmb{\mathcal{A}}(I, P, \mathbf{u}) \,
    \mathrm{E} \Big[ \mathbf{y} \, \Big| \, \pmb{\theta}_\bullet \Big]
    p(I) \, \mathrm{d}I
\end{align}
%
...
the shape parameters of the latitude distribution $a$ and $b$, and
the mean $r$ and half-width $\Delta$ of the spot radius
distribution.
...
\begin{subequations}
    \begin{align}
        \left( N \,\,\, c \,\,\, a \,\,\, b \,\,\, r \,\,\, \Delta \right)^\top
         & =\left( 10 \,\,\,\,\,\,\,\,\, 0.10 \,\,\,\,\,\,\,\,\, 0.40 \,\,\,\,\,\,\,\,\, 0.27 \,\,\,\,\,\,\,\,\, 10.0 \,\,\,\,\,\,\,\,\, 0.00 \right)^\top \\
         & =\left( 10 \,\,\,\,\,\,\,\,\, 0.10 \,\,\,\,\,\,\,\,\, 0.31 \,\,\,\,\,\,\,\,\, 0.36 \,\,\,\,\,\,\,\,\, 10.0 \,\,\,\,\,\,\,\,\, 0.00 \right)^\top \\
         & =\left( 10 \,\,\,\,\,\,\,\,\, 0.05 \,\,\,\,\,\,\,\,\, 0.28 \,\,\,\,\,\,\,\,\, 0.00 \,\,\,\,\,\,\,\,\, 30.0 \,\,\,\,\,\,\,\,\, 0.00 \right)^\top \\
         & =\left( 20 \,\,\,\,\,\,\,\,\, 0.10 \,\,\,\,\,\,\,\,\, 0.06 \,\,\,\,\,\,\,\,\, 0.00 \,\,\,\,\,\,\,\,\, 10.0 \,\,\,\,\,\,\,\,\, 0.00 \right)^\top
        \quad.
    \end{align}
\end{subequations}
%
...
$30^\circ \pm 5^\circ$ latitude with a contrast of $10\%$.
Note that the conversion between the shape parameters $a$ and $b$ and
the more intuitive mean $\mu_\phi$ and standard deviation $\sigma_\phi$
of the spot latitude distribution is given in \S\ref{sec:lat-transform}.
...
In the previous section we derived a closed form solution to the (best possible)
...
%
$p ( \tilde{\mathbf{f}\hspace{0.2em}} \, \big| \, P, \mathbf{u}, \pmb{\theta}_\bullet )$
%
...
a surface with $N$ discrete circular spots of fixed, uniform contrast $c$
and radius $r \pm \Delta$ at latitudes $\mu_\phi \pm \sigma_\phi$.
Let us then expand each surface in spherical harmonics and visualize the
distribution of coefficients $y^l_m$. Figure~\ref{fig:nongaussianity}
...
intialized
to zero. We then add $N$ spots to this grid, each of fractional contrast
$c$ and radius $r$ centered at latitude $\phi$ and longitude $\lambda$,
by decreasing the intensity at all points within an angular distance $r$
(measured along the surface of the sphere) by an amount $c$.
...
(Appendix \ref{sec:starry}), assuming an inclination $I$, a rotational period $P$,
...
\footnote{
    In theory, we should do this in the reverse order: i.e., we should add photon
    noise and \emph{then} normalize the light curve to the mean, since that is the order in which
    ...
    our inference results, so we opt for the faster of the two methods. Note, of course,
    that when applying our GP to real data, we won't have this choice!
}
The default values of each of the parameters mentioned above are given in
...
\begin{figure}[t!]
    \begin{centering}
        ...
        \oscaption{nullspace_ensemble}{%
            ...
            stellar light curve at 1 (thin blue curves),
            3 (thin orange curves), 10 (thin green curves), and 30 (thin red
            curves) random inclinations. The thicker curves correspond to
...
See Figures~\ref{fig:nullspace_ensemble_ld} and \ref{fig:nullspace_ensemble_ld_var}.

\begin{figure}[t!]
    \begin{centering}
        \includegraphics[width=\linewidth]{figures/nullspace_ensemble_ld.pdf}
        \oscaption{nullspace_ensemble_ld}{%
            Same as Figure~\ref{fig:nullspace_ensemble}, but for limb-darkened
            stars with coefficients $u_1 = 0.5$ and $u_2 = 0.25$.
...
\begin{figure}[t!]
    \begin{centering}
        ...
        \oscaption{nullspace_ensemble_ld_var}{%
            ...
            a 10\% variation in each of the two limb darkening coefficients
...
\subsection{The number-contrast degeneracy}
\label{sec:cN-degeneracy}
...
%
\begin{align}
    \mathbf{s}(\rho) = \pmb{\mathcal{I}} \, \tilde{\mathbf{s}}(\rho)
\end{align}
%
...
To find the coefficients $\tilde{\mathbf{s}}(\rho)$
(and hence $\mathbf{s}(\rho)$), we solve the (linear) inverse problem,
%
\begin{align}
...
and
\begin{proof}{test_erho}
    \chi_k^-(r, \Delta) & \equiv \exp\left(\frac{r -\Delta -\vartheta_k}{s}\right)
    \nonumber                                                              \\
    \chi_k^+(r, \Delta) & \equiv \exp\left(\frac{r +\Delta -\vartheta_k}{s}\right)
    \quad.
\end{proof}
...
\begin{proof}{test_erho}
    ...
    & =
    \pmb{\mathcal{I}} \,
    \mathbf{B}^+ \, \mathbf{c}(r, \Delta)
    \quad.
\end{proof}
%
Note, finally, that in the limit $\Delta \rightarrow 0$,
%
\begin{proof}{test_erho}
...
\begin{proof}{test_bigErho}
    ...
    &=
    \pmb{\mathcal{I}} \,
    \mathbf{B}^+ \mathbf{C} (r, \Delta) {\mathbf{B}^+}^\top
    \pmb{\mathcal{I}}^\top
    \quad.
\end{proof}
%
Finally, in the limit $\Delta \rightarrow 0$,
%
\begin{proof}{test_bigErho}
    \lim_{\Delta \rightarrow 0}
    \mathbf{E}_\rho
...
\begin{align}
    ...
    {({D^{l'}_{\hat{\mathbf{x}}}})_{}}_{m',{\mu'}}(\phi) \,
    p(\phi \, \big| \, \pmb{\theta}_{\phi}) \,
    \mathrm{d}\phi
    %
    \nonumber \\[0.5em]
    ...
    \resizebox{.75\hsize}{!}{$
        ...
        \sum\limits_{{\mu'}=-l'}^{l'}
        {(\bar{E}^{l,l'}_r)_{}}_{\mu,{\mu'}} \,
        \mathrm{e}^{\frac{\imag \pi}{2}(m - \mu + m' - {\mu'})}
        \sum\limits_{i=0}^{2l}
        \sum\limits_{i'=0}^{2l'}
        c_{m,\mu,i}^{l}
        c_{m',{\mu'},i'}^{l'}
...
\begin{align}
    ...
    ({D^{l'}_{\hat{\mathbf{x}}}})_{m',{\mu'}}(\lambda) \,
    p(\lambda \, \big| \, \pmb{\theta}_{\lambda}) \,
    \mathrm{d}\lambda
    %
    \nonumber \\[0.5em]
