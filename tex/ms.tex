...
%
Our goal now is to characterize the distribution of $y_{lm}$ values as a
...
first two moments of the distribution of $y_{lm}$ conditioned on the parameters
