...
Unlike traditional SL methods, which are inherently noisy, our method employs
...
of the cosmic microwave background. In particular, it is a type of
Gaussian random field (GRF) on the sphere \citep{Wandelt2012} \xxx{...}

Finally, our method is also related to various families of approximate inference, such as
variational inference (VI), in which a multivariate Gaussian is used to
approximate the \emph{posterior} distribution, or to approximate Bayesian
computation (ABC) \xxx{...}

\xxx{TODO: Discuss \citet{Basri2020}, how we agree and disagree. Compare to Brett's
    paper using ABC to measure spot sizes as a function of spectral type.}
