...
variational inference \citep[ADVI;][]{?}, and nested sampling \citep{?}.
We obtained the best performance using the nested sampling algorithm
implemented in the \textsf{dynesty} package \citep{?}, so that is what
we will use below.
...
default values
(multi-ellipsoidal decomposition for bounds determination,
