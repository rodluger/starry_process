...
\end{align}
%
where $P$ is the stellar rotation period, $\mathbf{u}$ are its limb darkening
coefficients,
...
Examples. Figure~\ref{fig:samples}.
...
Gaussian approximation to the marginal likelihood function for stellar
light curves conditioned on a vector $\pmb{\theta}_\bullet$
of spot hyperparameters. The true likelihood, however, is certainly \emph{not}
Gaussian.
